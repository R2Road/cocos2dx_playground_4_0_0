...
namespace graph_practice
{
	...
	bool Collection01Scene::init()
	{
		...
		//
		{
			auto graph_view_node = GraphAndNameNode::create( { false, false }, "quadratic In", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::quadraticIn( g_x ); } );
			graph_view_node->setPosition(
				visibleOrigin
		...
		//
		{
			auto graph_view_node = GraphAndNameNode::create( { false, false }, "quadratic Out", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::quadraticOut( g_x ); } );
			graph_view_node->setPosition(
				visibleOrigin
		...
		//
		{
			auto graph_view_node = GraphAndNameNode::create( { false, false }, "quadratic In Out", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::quadraticInOut( g_x ); } );
			graph_view_node->setPosition(
				visibleOrigin
		...
		//
		{
			auto graph_view_node = GraphAndNameNode::create( { false, false }, "sineEase In", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::sineEaseIn( g_x ); } );
			graph_view_node->setPosition(
				visibleOrigin
		...
		//
		{
			auto graph_view_node = GraphAndNameNode::create( { false, false }, "sineEase Out", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::sineEaseOut( g_x ); } );
			graph_view_node->setPosition(
				visibleOrigin
		...
		//
		{
			auto graph_view_node = GraphAndNameNode::create( { false, false }, "sineEase In Out", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::sineEaseInOut( g_x ); } );
			graph_view_node->setPosition(
				visibleOrigin
		...
		// Setup
		//
		schedule( CC_SCHEDULE_SELECTOR( Collection01Scene::update4Graph ) );
	...
	void Collection01Scene::update4Graph( float dt )
	{
		if( !mbPause )
		{
