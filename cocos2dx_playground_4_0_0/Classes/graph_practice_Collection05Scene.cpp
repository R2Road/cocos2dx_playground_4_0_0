...
namespace graph_practice
{
	...
	bool Collection05Scene::init()
	{
		...
		//
		{
			auto graph_view_node = GraphAndNameNode::create( { false, false }, "elasticEase In", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::elasticEaseIn( g_x, 1.f ); } );
			graph_view_node->setPosition(
				visibleOrigin
		...
		//
		{
			auto graph_view_node = GraphAndNameNode::create( { false, false }, "elasticEase Out", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::elasticEaseOut( g_x, 1.f ); } );
			graph_view_node->setPosition(
				visibleOrigin
		...
		//
		{
			auto graph_view_node = GraphAndNameNode::create( { false, false }, "elasticEase In Out", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::elasticEaseInOut( g_x, 1.f ); } );
			graph_view_node->setPosition(
				visibleOrigin
		...
		//
		{
			auto graph_view_node = GraphAndNameNode::create( { false, false }, "backEase In", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::backEaseIn( g_x ); } );
			graph_view_node->setPosition(
				visibleOrigin
		...
		//
		{
			auto graph_view_node = GraphAndNameNode::create( { false, false }, "backEase Out", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::backEaseOut( g_x ); } );
			graph_view_node->setPosition(
				visibleOrigin
		...
		//
		{
			auto graph_view_node = GraphAndNameNode::create( { false, false }, "backEase In Out", GraphWidth, GraphHeight, []( float g_x )->float { return tweenfunc::backEaseInOut( g_x ); } );
			graph_view_node->setPosition(
				visibleOrigin
		...
		// Setup
		//
		schedule( CC_SCHEDULE_SELECTOR( Collection05Scene::update4Graph ) );
	...
	void Collection05Scene::update4Graph( float dt )
	{
		if( !mbPause )
		{
