...
namespace step_typetype
{
	...
	bool ScheduleScene::init()
	{
		...
		//
		{
			...
			schedule( CC_SCHEDULE_SELECTOR( ScheduleScene::customeUpdate ), 0.1f );
	...
	void ScheduleScene::onKeyPressed( EventKeyboard::KeyCode keycode, Event* /*event*/ )
	{
		...
		{
			if( isScheduled( CC_SCHEDULE_SELECTOR( ScheduleScene::customeUpdate ) ) )
			{
				unschedule( CC_SCHEDULE_SELECTOR( ScheduleScene::customeUpdate ) );
			}
		}
