...
namespace ui_research
{
	namespace gauge_research
	{
		...
		{
			if( !isScheduled( CC_SCHEDULE_SELECTOR( AnimationScene::update4GaugeAnimation ) ) )
			{
				schedule( CC_SCHEDULE_SELECTOR( AnimationScene::update4GaugeAnimation ) );
			}
		}
		void AnimationScene::update4GaugeAnimation( float /*delta_time*/ )
		{
			...
			{
				unschedule( CC_SCHEDULE_SELECTOR( AnimationScene::update4GaugeAnimation ) );
				return;
			}
